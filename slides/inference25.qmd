...
ggplot(data.frame(x = x, density = density), aes(x = x, y = density)) +
  ...
  scale_fill_manual(values = c("Lower Tail" = "#005A43", "Upper Tail" = "#005A43"), 
...
ggplot(data.frame(x = x, density = density), aes(x = x, y = density)) +
  ...
  scale_fill_manual(values = c("Upper Tail" = "#005A43"), 
